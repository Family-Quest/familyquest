...
<template>
  <kPage class="bg-[url('public/back.png')] bg-cover">
    <kBlock>
      <div class="mx-auto h-16 w-60 rounded bg-white p-2"><img alt="logo" class="object-cover" src="public/logo.png"></div>
    </kBlock>
    <kBlock inset outline strong>
      <h2 class="text-xl font-bold">{{ t('common.register') }}</h2>
      <div class="mb-5 flex flex-col">
        ...
        <kButton @click="signIn">{{ t('common.register') }}</kButton>
      </div>
      ...
      <hr class="my-6 h-px border-0 bg-gray-200 dark:bg-gray-700">
      <div>
        <p class="text-xs">{{ t('common.have-account') }}</p>
        <nuxt-link
